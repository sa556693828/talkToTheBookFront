          ...
          {!isAuthenticated ? (
            <>
              <div className="flex items-center justify-center mb-8">
                {isLoading ? (
                  <BiUser className="w-16 h-16 text-amber-700 animate-bounce" />
                ) : (
                  <BiUser className="w-16 h-16 text-amber-700" />
                )}
              </div>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full p-4 mt-2 border rounded-lg border-amber-200 focus:ring-2 text-black focus:ring-amber-500 focus:border-transparent"
                    placeholder="請輸入密碼"
                  />
                </div>
